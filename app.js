    ...
    <div class="cert-card-wrap" onclick="flipCert(this)" style="perspective:1000px;margin-bottom:14px;cursor:pointer;position:relative;">
      <div class="cert-card" style="position:relative;width:100%;height:200px;transition:transform 0.6s;transform-style:preserve-3d;">
        <div style="position:absolute;inset:0;backface-visibility:hidden;border-radius:14px;overflow:hidden;background:linear-gradient(135deg,${bgColor},${bgColor}dd,#0f1923);border:1px solid rgba(255,255,255,0.1);padding:16px;display:flex;flex-direction:column;justify-content:space-between;box-shadow:0 8px 32px rgba(0,0,0,0.3);">
          ...
          <svg style="position:absolute;right:8px;bottom:8px;opacity:0.25;width:100px;height:100px;pointer-events:none;" viewBox="0 0 100 100" fill="none"><path d="M50 20c-10 0-18 7-18 16 0 5 2 9 6 12 0 0-3 4-5 10s-3 14 0 16c2 1 4-2 5-6 1-3 2-7 3-9 1 3 1 8 0 13s-1 12 2 13c2 1 4-3 4-7 1-4 1-9 1-12 1 3 3 7 4 11s3 10 5 10c2-1 2-5 1-9s-2-8-3-11c2 3 5 7 7 10s5 7 6 6c2-2-1-6-3-10s-5-8-6-10c3 2 7 5 11 7s8 3 8 1c0-3-5-5-9-7s-8-4-10-6c1-2 2-4 2-7 0-3-1-5-2-7 4-3 6-7 6-12 0-9-8-16-18-16z" stroke="#2dd4bf" stroke-width="2" fill="#2dd4bf" fill-opacity="0.15"/><circle cx="43" cy="33" r="3" fill="#2dd4bf"/><circle cx="57" cy="33" r="3" fill="#2dd4bf"/></svg>
