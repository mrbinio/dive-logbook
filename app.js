const T = {
  en: {
    ...
    shopTitle:'AquaNaut — Shop', shopDesc:'Dive gear, courses, accessories — all in one place',
  ...
  pl: {
    ...
    shopTitle:'AquaNaut — Sklep', shopDesc:'Sprzęt nurkowy, kursy, akcesoria — wszystko w jednym miejscu',
