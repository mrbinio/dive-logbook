const T = {
  en: {
    ...
    shopTitle:'biniodive — Shop', shopDesc:'Dive gear, courses, accessories — all in one place',
  ...
  pl: {
    ...
    shopTitle:'biniodive — Sklep', shopDesc:'Sprzęt nurkowy, kursy, akcesoria — wszystko w jednym miejscu',
